                              ...
                              <div className='ms-3'>
                                {stack?.url ? (
                                  <Link
                                    href={stack?.url}
                                    target={'_blank'}
                                    className={`m-0 block cursor-pointer break-words p-0 text-xl font-semibold text-theme-secondary underline duration-200 xl:whitespace-nowrap xl:break-normal dark:text-theme-dark-secondary`}
                                  >
                                    {stack.name}
                                  </Link>
                                ) : (
