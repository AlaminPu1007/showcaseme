  ...
  <footer id='footer-widget'>
    <div className='container duration-200 md:mt-[80px]'>
      <div className='my-[25px] flex items-center'>
        <Link
          href='/'
          className='text-theme-secondary dark:text-theme-dark-primary pr-2 text-2xl sm:pr-4 sm:text-4xl md:pr-0'
        >
          Alamin
        </Link>
        ...
        <div className='ms-auto flex items-center duration-200'>
          <Link
            ...
            className='after-hover-animation text-theme-secondary dark:text-theme-dark-secondary relative me-[40px] mb-[2px] hidden text-base duration-200 md:inline-block lg:text-lg'
          >
      ...
      <div className='dark:bg-theme-dark-primary block h-[0.5px] bg-[#E2E1E5] opacity-80 duration-200 dark:opacity-50' />
      ...
      <div className='my-[25px] flex flex-col items-center justify-between lg:flex-row'>
        ...
        <p className='text-theme-primary dark:text-theme-dark-primary mt-[25px] pb-1 text-center text-sm lg:mt-0'>
