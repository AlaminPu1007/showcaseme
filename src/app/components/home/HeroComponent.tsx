    ...
    <div className='container my-[30px] duration-200 md:my-[50px]'>
      <div className='item-center relative flex justify-center'>
        <div className='text-center'>
          <h5 className='text-md text-theme-dark-bg m-0 p-0 font-bold dark:text-white'>
            {`Hello 👋, I'am`}
          </h5>
          <h1 className='text-theme-secondary m-0 p-0 py-3 text-4xl font-bold tracking-[.06em] lg:text-5xl dark:text-white'>
            Md Alamin
          </h1>
          <h4 className='text-md dark:text-theme-white m-0 p-0 font-medium tracking-wide'>
            Software Engineer
          </h4>
          <div className='item-center my-8 flex flex-col justify-center sm:flex-row'>
            ...
            <Link
              href={'/#footer-widget'}
              className='medium bg-theme-btn dark:hover:text-theme-dark-bg inline-block rounded-md border-[1px] px-5 py-3 text-white duration-200 hover:text-white dark:border-0 dark:hover:bg-white'
            >
              {`Let's talk`}
            </Link>
          </div>
          <div className='item-center flex shrink-[0] justify-center'>
            <div className='border-theme-white dark:border-theme-white relative h-[280px] w-[280px] overflow-hidden rounded-full border-[0.5px] sm:h-[350px] sm:w-[350px]'>
              <Image
                alt='user-avatar'
        ...
        <div className='absolute bottom-[35%] left-0 hidden flex-col items-center justify-between sm:flex'>
          <div className='bg-theme-primary dark:bg-theme-btn mb-3 h-[35px] w-[1px] duration-200'></div>
          <Link
            target='_blank'
          ...
          >
            ...
            >
              <path
                ...
                fill='#666666'
                className='group-hover:fill-theme-btn dark:fill-theme-btn duration-200 dark:group-hover:fill-white'
              />
            </svg>
          </Link>
          ...
          <div className='bg-theme-primary dark:bg-theme-btn mt-3 h-[35px] w-[1px] duration-200'></div>
        </div>
      </div>
    </div>
  );
